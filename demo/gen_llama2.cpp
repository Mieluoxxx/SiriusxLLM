 ...
 * @Date: 2025-02-27 18:01:01
 * @LastEditors: Morgan Woods weiyiding0@gmail.com
 * @LastEditTime: 2025-04-02 22:34:38
 * @FilePath: /SiriusxLLM/demo/gen_llama2.cpp
 * @Description: 
 */
...
void print_help(const std::string& program_name) {
    std::cout << "用法: " << program_name << " [参数]\n"
              ...
              << "  [提示词]           生成文本的起始提示词 (默认: 'long long ago,')\n"
              << "  -h                显示帮助信息\n";
}
...
int main(int argc, char* argv[]) {
    ...
    std::string prompt = (argc > 6) ? argv[6] : "long long ago,";
